      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12" style={{ background: "#f5f0e8" }}>
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 flex items-center rounded-full bg-white p-1 shadow-sm" style={{ border: "1px solid #e8e0d0" }}>
            <Link href="/auth/register" className="flex-1 rounded-full py-2.5 text-center text-sm font-medium text-stone-500 hover:text-stone-700 transition-colors">
              Create account
            </Link>
          ...
          <h2 className="text-3xl font-bold text-stone-900" style={{ fontFamily: "Georgia, serif" }}>Welcome back</h2>
          <p className="mt-1.5 text-sm text-stone-500">Sign in to your VoiceLedger account.</p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <Link href="/auth/reset" className="text-xs text-stone-400 underline underline-offset-2 hover:text-stone-600 transition-colors">
                  Forgot password?
                </Link>
              </div>
            ...
            >
              {loading ? "Signing in…" : <>Sign in <span className="text-base">→</span></>}
            </button>
          </form>
          ...
          <p className="mt-5 text-center text-sm text-stone-500">
            ...
            <Link href="/auth/register" className="font-bold text-stone-900 hover:text-teal-700 transition-colors">
              Sign up free
            </Link>
          </p>
